...
public class UIMainWindow extends JFrame implements IObserver {
	...
	private Class synchronizedResponseClass;
	private Class synchronizedWaitClass;
	private IEventBusConnector eventBusConn;

	private ArrayList<IEventSynchronized> synchronizedEvents;
	...
	public UIMainWindow(
		...
		String syncText,
		int delay,
		Class synchronizedResponseClass,
		Class synchronizedWaitClass
	) {
		this(eventBusConn, name, syncText, delay);
		this.synchronizedResponseClass = synchronizedResponseClass;
		this.synchronizedWaitClass = synchronizedWaitClass;
		this.eventBusConn = eventBusConn;
		this.synchronizedEvents = new ArrayList<IEventSynchronized>();
	}
