...
import events.EventSynchronizedResponseForPartOne;
import events.EventSynchronizedResponseForPartTwo;
...
public class MainPartTwo {
	...
	public static void main(String[] args) {
		...
		listenedEvents.add(EventSynchronizedResponseForPartOne.class);
		...
		UIMainWindow window = new UIMainWindow(
			...
			"Avez",
			2,
			EventSynchronizedResponseForPartTwo.class,
			EventSynchronizedResponseForPartOne.class
		);
